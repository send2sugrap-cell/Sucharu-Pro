...
CREATE TABLE IF NOT EXISTS auth_accounts (
    ...
    account_status VARCHAR(30) NOT NULL DEFAULT 'ACTIVE' CHECK (account_status IN ('PENDING', 'ACTIVE', 'INACTIVE', 'SUSPENDED', 'LOCKED', 'PENDING_VERIFICATION', 'DEACTIVATED', 'SECURITY_REVIEW', 'DELETED')),
