package com.sucharu.sucharupro.domain.repository.businesscost
...
/**
 * Domain Repository interface for Cost Centers, Categories, Tracking and Reclassifications.
 */
interface BusinessCostManagementRepository {
