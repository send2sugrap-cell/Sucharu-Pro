package com.sucharu.sucharupro.domain.repository.machine.maintenance
...
/**
 * Domain Repository interface for Machine Maintenance operations.
 */
interface MachineMaintenanceRepository {
