...
/**
 * Domain Repository interface for Vendor Performance, Evaluation, Compliance, and Corrective Actions (Module 12 Step 09).
 */
interface VendorPerformanceRepository {
