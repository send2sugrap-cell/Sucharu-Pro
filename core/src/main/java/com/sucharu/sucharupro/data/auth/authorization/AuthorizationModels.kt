...
enum class AuthorizationCapability {
    ...
    // Machine & Equipment capabilities (Module 21 Step 01, Step 02, Step 05, Step 06, Step 07 & Step 08)
    READ_MACHINES,
    MANAGE_MACHINES,
    ...
    MANAGE_MAINTENANCE,
    READ_MACHINE_EVENTS,
    MANAGE_MACHINE_EVENTS,
    READ_MACHINE_DOWNTIME,
    MANAGE_MACHINE_DOWNTIME,
    READ_MACHINE_ALERTS,
    MANAGE_MACHINE_ALERTS,
    ...
    // Module 24 Reporting & Analytics Foundation capabilities
    REPORT_VIEW_SALES,
    REPORT_VIEW_CUSTOMER,
    REPORT_VIEW_ORDER,
    REPORT_VIEW_PRODUCTION,
    REPORT_VIEW_QUALITY,
    REPORT_VIEW_INVENTORY,
    REPORT_VIEW_DELIVERY,
    REPORT_VIEW_FINANCE,
    REPORT_VIEW_PROFITABILITY,
    REPORT_VIEW_AFFILIATE,
    REPORT_VIEW_WALLET_PAYOUT,
    REPORT_VIEW_MACHINE_OPERATIONS,
    REPORT_VIEW_PREFLIGHT,
    REPORT_VIEW_AUDIT,
    REPORT_VIEW_EXECUTIVE_ANALYTICS,
    REPORT_EXPORT
}
