...
object RoleCapabilityMatrix {
    ...
    private val staffCapabilities: Set<AuthorizationCapability> = publicCapabilities + authenticatedIdentityCapabilities + setOf(
        ...
        AuthorizationCapability.READ_MACHINE_EVENTS,
        AuthorizationCapability.MANAGE_MACHINE_EVENTS,
        AuthorizationCapability.READ_MACHINE_DOWNTIME,
        ...
        AuthorizationCapability.READ_PREFLIGHT,
        AuthorizationCapability.EXECUTE_PREFLIGHT,
        AuthorizationCapability.MANAGE_PREFLIGHT_RULES,
