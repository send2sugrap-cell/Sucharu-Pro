...
/**
 * Data Source Interface for Affiliate Communication, Notification & Lifecycle Governance.
 * Module 20 Step 04.
 */
interface AffiliateCommunicationDataSource {
    ...
    suspend fun saveAuditRecord(record: AffiliateCommunicationAuditRecord): AffiliateCommunicationAuditRecord
