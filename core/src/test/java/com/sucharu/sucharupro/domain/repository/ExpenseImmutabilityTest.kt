...
class ExpenseImmutabilityTest {
    ...
    @Test
    fun `posted expenses are completely immutable and reject edits`() = runBlocking {
        ...
        val exp = (expenseRepository.createExpense(
            ...
            currency = "BDT",
            description = "Expense immutability test",
        ...
        // Attempting to update a posted expense
        val editRes = expenseRepository.updateDraftExpense(
