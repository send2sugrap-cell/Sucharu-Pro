...
class CustomerCreditNoteTest {
    ...
    @Test
    fun `posting customer credit note adjustment creates credit note record`() = runBlocking {
        ...
        assertEquals(Money(BigDecimal("3000.00")), creditNote.amount)
        assertEquals("PRJ-01", creditNote.projectId)
    }
}
