...
class DeliveryAnalyticsShipmentIntegrationTest {
    ...
    @Test
    fun `shipment status integrates cleanly into delivery analytics summary`() = runBlocking {
        ...
        assertEquals(1, summary.totalDelivered)
    }
}
