...
/**
 * Re-QC integration tests for Final QC (Module 06 Step 07).
 */
class FinalQcReQcIntegrationTest {
    ...
    @Test
    fun release_blockedWhenReQcFailed() = runBlocking {
        // Seed failed Re-QC
        ...
        assertTrue((releaseRes as DomainResult.Error).message.contains("Unresolved or failed Re-QC cycle remains"))
    }
}
