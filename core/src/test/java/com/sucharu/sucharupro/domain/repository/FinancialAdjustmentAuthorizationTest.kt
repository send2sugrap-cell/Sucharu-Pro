...
class FinancialAdjustmentAuthorizationTest {
    ...
    @Test
    fun `external users cannot create or post financial adjustments`() = runBlocking {
        val custCreate = adjustmentRepository.createAdjustment(
            projectId = "PRJ-01",
        ...
        val vendCreate = adjustmentRepository.createAdjustment(
            projectId = "PRJ-01",
