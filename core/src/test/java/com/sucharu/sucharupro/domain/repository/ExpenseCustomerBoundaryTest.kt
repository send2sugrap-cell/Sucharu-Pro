...
class ExpenseCustomerBoundaryTest {
    ...
    @Test
    fun `expense operations do not mutate CustomerReceivable records`() = runBlocking {
        ...
        // CustomerReceivable state remains completely untouched
        val receivables = customerReceivableDataSource.observeReceivables("PRJ-01").first()
        assertEquals(0, receivables.size)
    }
}
