...
sealed class AppDestination(
    ...
    sealed class Staff(
        ...
        object SubstrateEnterpriseAudit : Staff("staff/substrate-enterprise-audit", "Substrate Enterprise Audit & Handoff", AuthorizationCapability.STAFF_READ_INVENTORY)
        object AffiliateManagement : Staff("staff/affiliate-management", "Affiliate Management", AuthorizationCapability.STAFF_READ_ORDERS)
    ...
    sealed class Manager(
        ...
        object SubstrateEnterpriseAudit : Manager("manager/substrate-enterprise-audit", "Substrate Enterprise Audit & Handoff", AuthorizationCapability.STAFF_READ_INVENTORY)
        object AffiliateManagement : Manager("manager/affiliate-management", "Affiliate Governance & Approvals", AuthorizationCapability.MANAGER_APPROVE_ORDER)
    ...
    sealed class Admin(
        ...
        object SubstrateEnterpriseAudit : Admin("admin/substrate-enterprise-audit", "Substrate Enterprise Audit & Handoff", AuthorizationCapability.ADMIN_ALL)
        object AffiliateManagement : Admin("admin/affiliate-management", "Affiliate Governance & Administration", AuthorizationCapability.ADMIN_ALL)
